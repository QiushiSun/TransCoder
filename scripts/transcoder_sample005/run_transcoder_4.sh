...
for model in "${model_lst[@]}"; do
    ...
    # CUDA_VISIBLE_DEVICES=3 bash run_sample005.sh $model summarize2cls
    # CUDA_VISIBLE_DEVICES=3 bash run_sample005.sh $model translate2summarize
    ...
    CUDA_VISIBLE_DEVICES=3 bash run_sample005.sh $model cross2go
